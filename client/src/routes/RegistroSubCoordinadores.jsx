...
export const RegistroSubCoordinadores = () => {
	...
	/**
	 * Declaracion de variable de estado para datos del encargado el caso de modificación
	 */
	const [dataSubCoordinador, setDataSubCoordinador] = useState();
	...
	const validationSchema = Yup.object().shape({
		...
		CoordinadoreId: Yup.string().required("Ingrese un Coordinador"),
	});
	...
	return (
		<Flex align="center" justify="center" h="auto">
			<Box rounded="md" p={6} w="full">
				<Formik
					initialValues={dataSubCoordinador || initialValues}
				...
				>
					{(formik) => (
						...
						>
							...
							<FormControl
								isInvalid={
									formik.errors.CoordinadoreId && formik.touched.CoordinadoreId
								}
							>
								<FormLabel>
									Coordinador
